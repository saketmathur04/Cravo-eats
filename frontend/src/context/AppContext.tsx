 ...
 * 
 * Manages user authentication state, current geolocation, 
 * and the customer's active shopping cart across all routes.
 */
export const AppProvider = ({ children }: AppProviderProps) => {
  ...
  /**
   * Validates the JWT token stored in localStorage and 
  ...
  /**
   * Fetches the active cart for the authenticated customer.
  ...
  useEffect(() => {
    ...
    navigator.geolocation.getCurrentPosition(async (position) => {
      ...
      setLocation({
        ...
        formattedAddress: "Default Location (Geolocation Denied)",
      });
      setCity("Delhi");
      setLoadingLocation(false);
    });
