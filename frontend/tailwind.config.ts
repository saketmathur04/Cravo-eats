...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        // Fluid typography
        'display-2xl': ['clamp(3.5rem, 8vw, 7rem)', { lineHeight: '0.95', letterSpacing: '-0.04em', fontWeight: '600' }],
        'display-xl': ['clamp(2.75rem, 6vw, 5rem)', { lineHeight: '1', letterSpacing: '-0.035em', fontWeight: '600' }],
      ...
      animation: {
        ...
        "word-cycle": "word-cycle 3s ease-in-out infinite",
      },
    },
  },
